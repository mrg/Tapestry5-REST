...
public class Layout
{
    ...
    private boolean isActiveNg()
    {
        ...
        if (_activePage.equalsIgnoreCase("NgPhones"))
            _isActive = true;
        if (_activePage.equalsIgnoreCase("NgTodo"))
            _isActive = true;
        return _isActive;
    }
    ...
    private boolean isActiveReact()
    {
        ...
        if (_activePage.equalsIgnoreCase("ReactTapestry"))
            _isActive = true;
        return _isActive;
    }
    ...
    private boolean isActiveChart()
    {
        ...
        if (_activePage.equalsIgnoreCase("Jchart"))
            _isActive = true;
        if (_activePage.equalsIgnoreCase("Raphael"))
            _isActive = true;
        return _isActive;
    }
